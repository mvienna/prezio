<template>
      ...
      <div class="column no-wrap">
        ...
        >
          ...
          <q-btn
            ...
            round
            :class="
              item === text.verticalAlign ? 'text-black bg-grey-2' : 'text-grey'
            "
            :icon="
  ...
  <q-select
    ...
    dense
    options-dense
    style="width: 80px; min-width: 25px; max-width: 70px"
    @update:model-value="
      () => {
        studioStore.applyCustomization();
      }
  ...
  <q-select
    ...
    options-dense
    suffix="px"
    style="max-width: 90px; min-width: 25px"
    @update:model-value="
      () => {
        studioStore.applyCustomization();
      }
