      ...
      tabs: {
        ...
        settings: {
          ...
          points: {
            ...
            scoreDependsOnTime: {
              title: "Чем быстрее ответят, тем больше балл",
              description: {
            ...
            partialScoring: {
              ...
              description:
                "Участники получат баллы за каждый правильный ответ, но при выборе хотя бы одного неверного ответа, получит минимальный балл",
            },
          },
          ...
          leaderboard: {
            ...
            description:
              "Показывать таблицу лидеров после этого вопроса с результатами всей викторины?",
          },
